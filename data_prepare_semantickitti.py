...
parser.add_argument('--src_path', default="/home/henry/docker_shared/dataset/sequences", help='source dataset path [default: None]')
parser.add_argument('--dst_path', default="/home/henry/docker_shared/dataset_out", help='destination dataset path [default: None]')
